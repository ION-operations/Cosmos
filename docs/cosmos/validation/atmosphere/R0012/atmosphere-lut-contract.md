...
|---|---:|---|
| transmittance | 320×80 | RGB=curved-path solar transmittance, A=compressed optical depth |
| multiScattering | 96×48 | RGB=phase-weighted multiple-scattering proxy, A=energy |
| skyView | 240×135 | RGB=sky-view radiance proxy with curved path samples, A=horizon/terminator |
| aerialPerspective | 128×72 | RGB=aerial-perspective path tint, A=fog density |
