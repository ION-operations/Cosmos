# Cosmos R-0008 visual debug overlay contract

This report is computed without screenshots. It defines the diagnostic colour contract for lead-eyes reviews where normal beauty renders cannot isolate scale, atmosphere, or cloud LOD failure.
